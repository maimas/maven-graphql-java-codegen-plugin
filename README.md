...
//Imports from the Generated API
import com.maimas.generated.UserServiceGraphQLProvider.Types.User;
import com.maimas.generated.UserServiceGraphQLProvider.Types.UserRole;
import static com.maimas.generated.UserServiceGraphQLProvider.*;
...
public class Examples {
    ...
    public void queryByUserId() throws JsonProcessingException {
        ...
        GQLQuery updateQuery = new Query().findById("123123",
                FragmentField.of(User.Fields.email),
                //Note the roles field - it is a nested object, and we want the 'name' and 'caption' fields. 
                FragmentField.of(User.Fields.roles),
                            FragmentField.of(UserRole.Fields.name),
                            FragmentField.of(UserRole.Fields.caption));
